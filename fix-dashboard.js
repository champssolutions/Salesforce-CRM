...
const targetPath = path.join(__dirname, 'src', 'controllers', 'analyticsController.js');

const correctCode = `const { getQuery } = require('../config/database');
...
console.log('✅ แก้ไขไฟล์ analyticsController.js เรียบร้อยแล้ว!');